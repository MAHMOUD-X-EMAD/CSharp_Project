        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_recipts_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BillTotalPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Exist = table.Column<int>(type: "int", nullable: false),
                    SupplierID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Orders_recipts_RecieptId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplierBillProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupplierBillProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_SupplierBillProducts_SupplierBills_SupplierBillId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_recipts_CustomerId",
                table: "recipts",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierBillProducts_ProductId",
                table: "SupplierBillProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierBillProducts_SupplierBillId",
                table: "SupplierBillProducts",
